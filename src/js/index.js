(() => {
  ...
  var API_PATH = "/www/canals5/phox/api";

  // lib/photoloader.js
  var PHOTOS_ENDPOINT = "/photos";
  function loadResource(uri) {
    return __async(this, null, function* () {
      try {
        const response = yield fetch(`${uri}`, { credentials: "include" });
        if (!response.ok) {
  ...
  function loadPicture(idPicture) {
    return __async(this, null, function* () {
      const picture = yield loadResource(`${BASE_URL}${API_PATH}${PHOTOS_ENDPOINT}/${idPicture}`);
  ...
  function displayPicture(pictureInformations) {
  ...
  function getPicture(id) {
    return __async(this, null, function* () {
      const pictureInformations = yield loadPicture(id);
